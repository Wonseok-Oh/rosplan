...
#include "hiprl_replicate/AlertPlanActionNum.h"
...
namespace KCL_rosplan {
	...
	public:
		...
		/* Wonseok made methods*/
		bool alertPlanActionNum(hiprl_replicate::AlertPlanActionNum::Request &req, hiprl_replicate::AlertPlanActionNum::Response &res);
