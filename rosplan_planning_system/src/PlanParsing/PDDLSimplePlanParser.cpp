...
namespace KCL_rosplan {
	...
	bool PDDLSimplePlanParser::alertPlanActionNum(hiprl_replicate::AlertPlanActionNum::Request &req, hiprl_replicate::AlertPlanActionNum::Response &res){
		res.num_actions = action_list.size();
		return true;
	}
	...
	int main(int argc, char **argv) {
		...
		ros::ServiceServer service3 = nh.advertiseService("alert_plan_action_num", &KCL_rosplan::PDDLSimplePlanParser::alertPlanActionNum, &pp);
