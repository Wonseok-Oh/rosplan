...
namespace KCL_rosplan {
	...
	/*--------------------------------------/
	 * Process reset signal from HiPRL-Grid /
	 *-------------------------------------*/
	void PDDLKnowledgeBase::processReset(const rosplan_knowledge_msgs::processReset::ConstPtr &msg){
		ROS_INFO("processReset signal");
		std_srvs::Empty::Request temp_req_ = std_srvs::Empty::Request();
		std_srvs::Empty::Response temp_res_ = std_srvs::Empty::Response();
		std_srvs::Empty::Request &temp_req = temp_req_;
		std_srvs::Empty::Response &temp_res = temp_res_;
		clearKnowledge(temp_req, temp_res);
		parseDomain(msg->domain_path, msg->problem_path);
	}
    /*-----------------*/
    /* fetching domain */
    /*-----------------*/
